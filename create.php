...
<head>
    ...
    <title>Zsebbankár - Létrehozás</title>
                ...
                <div class="p-5">
                    ...
                    <form action="" method="post" class="user">
                        <div class="form-group row">
                            ...
                            Megnevezés:<input type="text" class="form-control form-control-user" name="title">
                            </div>
                            <div class="col-sm-6">
                            Leírás:<input type="text" class="form-control form-control-user" name="description">
                            </div>
                        </div>
                        <div class="form-group">
                        Összeg:<input type="text" class="form-control form-control-user" name="amount">
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            Dátum:<input type="date" class="form-control form-control-user" name="date">
                            </div>
                        </div>
                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Mentés" name="create">
                    </form>
                </div>
            </div>
        </div>
