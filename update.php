                ...
                <div class="container-fluid">
                    ...
                    include "config.php";
                        ...
                        if(isset($_POST['update'])) {
                            ...
                            // Step 5: Execute the statement and check for errors
                            if(mysqli_stmt_execute($stmt)) {
                              echo "Sikeres módosítás";
                              
                            } else {
                              echo "Hiba: " . mysqli_stmt_error($stmt);
                            }
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form action="" method="post" class="user">
                        ...
                        Összeg:<input type="text" class="form-control form-control-user" name="amount" value="<?php echo $amount; ?>">
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            Dátum:<input type="date" class="form-control form-control-user" name="date" value="<?php echo $date; ?>">
                            </div>
                        </div>
                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Mentés" name="update">
                    </form>
                </div>
            </div>
        </div>
